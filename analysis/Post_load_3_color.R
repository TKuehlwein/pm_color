...
# settings
dir_input  <- paste0(getwd(), "/stim_lists/dis/")
dir_output <- paste0(getwd(), "/stim_lists/dis/")
...
plt_all <- ggarrange(plt_load_3,
                     ncol = 1, nrow = 1, labels = "AUTO", common.legend = TRUE,
                     legend = "bottom", heights = c(1, 1, 1))


# =============================================================== save plots ===

ggsave(filename = paste0(dir_output, "color_distribution_l_3.pdf"),
       plot = plt_col_dist, width = 29.7, height = 10.0, units = "cm")

ggsave(filename = paste0(dir_output, "color_trial_conditions_l_3.pdf"),
       plot = plt_all, width = 21, height = 10.0, units = "cm")
